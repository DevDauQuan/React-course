...
const Header = () => {
    ...
    return (
        <Container className="flex-center">
            {user ? (
                <div className="flex-center header-user">
            ...
            <div className="flex-center header-cart">
                <span className="item">
                    <svg width="44" height="41" viewBox="0 0 44 41" fill="none" xmlns="http://www.w3.org/2000/svg" className="max-w-full">
                        <ellipse
                            cx="20.9584"
                            cy="37.7083"
                            rx="3.125"
                    ...
                    <span
                        className="span-quality flex-center">
                        {cartItemsCount || 0}
                    </span>
                </span>
                <span className="item">
